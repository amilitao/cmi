...
<body class="w3-light-gray">
	...
	<div class="w3-row">
			...
			<div class="container" style="margin-top: 50%">
				...
				<c:if test="${erroLogin}">
					<div class="w3-panel w3-center  w3-pale-yellow"
						...
						<p>
							<i class="fa fa-exclamation-triangle"></i> Login ou senha
							incorretos!!!
						</p>
					</div>
				...
				<form class="w3-container" action="acesso" method="post">
					<div class="w3-section">
						...
						<button class="w3-button w3-block w3-section w3-padding"
							type="submit" style="background: #78bd5d"><b>Entrar</b></button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="w3-col m9 w3-opacity-max">
			...
			<span style="position: absolute; top: 150px; left: 300px"> <img
				src="resources/style/images/icons-index/icon8.png" class="img-p1">
			</span>
			 <span style="position: absolute; top: 40px; left: 500px"> <img
				src="resources/style/images/icons-index/icon2.png" class="img2">
			</span> 
			<span style="position: absolute; top: 150px; left: 750px"> <img
				src="resources/style/images/icons-index/icon5.png" class="img-p2">
			</span>
			<span style="position: absolute; top: 40px; left: 900px"> <img
				src="resources/style/images/icons-index/icon3.png" class="img1">
				
				
				
			</span>
			 <span style="position: absolute; top: 300px; left: 200px"> <img
				src="resources/style/images/icons-index/icon4.png" class="img2">
			</span> 
			<span style="position: absolute; top: 300px; left: 600px"> <img
				src="resources/style/images/icons-index/icon1.png" class="img1">
			</span>
			<span style="position: absolute; top: 300px; left: 1000px"> <img
