		...
		<div class="w3-panel w3-padding-large">
			...
			<form action="controle" method="post">
				...
				<div class="w3-row-padding" style="margin: 0 -16px;">
					...
					<div class="w3-third w3-margin-bottom">
						<label><i class="fa fa-calendar-o"></i> Nome da transportadora</label>
						<input class="w3-input w3-border" type="text" name="nomeTransportadora" required>
					</div>					
				</div>
				<div class="w3-row-padding" style="margin: 0 -16px;">
					<div class="w3-third w3-margin-bottom">
					...
					<div class="w3-third w3-margin-bottom">
						<label><i class="fa fa-calendar-o"></i> Nfe de envio</label>
						<input class="w3-input w3-border" type="text" name="nfeEnvio" required>
					</div>
				...
				<button class="w3-button w3-khaki" type="submit"  <c:out value="${teste}" /> > 
