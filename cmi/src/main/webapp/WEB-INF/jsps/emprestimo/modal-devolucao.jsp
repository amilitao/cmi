...
<button
	onclick="document.getElementById('iddevolucao${emprestimo.id_emprestimo}').style.display='block'"
	class="w3-button w3-khaki" <c:out value="${param.b4}" />>
	<b>Devolução</b>
</button>

<div id="iddevolucao${emprestimo.id_emprestimo}" class="w3-modal">
	<div class="w3-modal-content w3-animate-top w3-card-4 w3-left-align">
		<header class="w3-container w3-khaki">
			<span
				onclick="document.getElementById('iddevolucao${emprestimo.id_emprestimo}').style.display='none'"
				...
				<div class="w3-row-padding" style="margin: 0 -16px;">
					...
					<div class="w3-col m3 w3-margin-bottom">
						<label><i class="fa fa-calendar-o"></i> Número do
							...
							value="${emprestimo.id_emprestimo}" name="id_emprestimo" readonly
							required>
					</div>
					<div class="w3-col m3 w3-margin-bottom">
